...
/*
Exercício 1 de BD III
Populem as tabelas de acordo com o MER desenvolvido nesta aula, com uma massa de dados consistente e concisa seguindo os seguintes critérios:
...
values ('2019-01-01','2019-01-04',1),
	   ('2019-01-05','2019-01-07',2),
       ('2019-01-12','2019-01-15',3),
       ('2019-01-15','2019-01-16',5),
       ('2019-01-20','2019-01-22',7);

insert into tbl_itempedido (qtde, i_cod_pedido, i_cod_produto, i_valor)  
values (2,1,1,(select valor from tbl_produto where cod_produto = 1));

insert into tbl_itempedido (qtde, i_cod_pedido, i_cod_produto, i_valor)
values (5,1,2,(select valor from tbl_produto where cod_produto = 2));

insert into tbl_itempedido (qtde, i_cod_pedido, i_cod_produto, i_valor)  
values (3,2,3,(select valor from tbl_produto where cod_produto = 3));

insert into tbl_itempedido (qtde, i_cod_pedido, i_cod_produto, i_valor)  
values (2,2,2,(select valor from tbl_produto where cod_produto = 2));

insert into tbl_itempedido (qtde, i_cod_pedido, i_cod_produto, i_valor)  
values (2,3,4,(select valor from tbl_produto where cod_produto = 4));

insert into tbl_itempedido (qtde, i_cod_pedido, i_cod_produto, i_valor)  
values (2,3,1,(select valor from tbl_produto where cod_produto = 1));

insert into tbl_itempedido (qtde, i_cod_pedido, i_cod_produto, i_valor)
values (2,4,2,(select valor from tbl_produto where cod_produto = 2));

insert into tbl_itempedido (qtde, i_cod_pedido, i_cod_produto, i_valor)  
values (2,4,3,(select valor from tbl_produto where cod_produto = 3));

insert into tbl_itempedido (qtde, i_cod_pedido, i_cod_produto, i_valor)  
values (2,5,4,(select valor from tbl_produto where cod_produto = 4));

insert into tbl_itempedido (qtde, i_cod_pedido, i_cod_produto, i_valor)  
values (2,1,3,(select valor from tbl_produto where cod_produto = 3));
